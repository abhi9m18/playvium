  ...
  return (
    ...
    "
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-10">
        <div className="bg-[#1c222b] rounded-2xl p-6 md:p-10">
          {/* Meta */}
          ...
          <div className="space-y-6 text-gray-200 leading-relaxed text-[15px]">
            ...
            <p>
              The Playvium Agreement (as defined below) includes a provision
              waiving the right to pursue any class, group, or representative
              claims and requires you to resolve any past, pending, or future
            ...
            <p>
              1.3 The term “person” refers to an individual, corporation, trust,
              or any legal entity.
            </p>

            <p>
              1.4 Any phrase including the terms “including”, “include”, or
              similar expressions shall be illustrative and shall not limit the
              scope of the words preceding those terms.
            </p>

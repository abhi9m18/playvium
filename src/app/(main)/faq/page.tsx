  ...
  return (
    <div className="w-full  bg-[#0F131A]">
      <div className="max-w-7xl mx-auto mt-[60px] md:mt-[66px] px-4 md:px-10 py-6">
        {/* Banner */}
        <div className="relative w-full h-36 md:h-48 bg-[#181D25] rounded-xl flex items-center">
        ...
        {/* FAQ List */}
        <div className="w-full rounded-xl mt-5 bg-[#1a1e23] border border-white/5 shadow-lg overflow-hidden">
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-white/5 last:border-none">
              <button
                ...
                className="w-full flex items-center justify-between px-4 md:px-6 py-4 text-left bg-[#1a1e23]"
              >
                ...
                <ChevronDown
                  className={`w-6 h-6 text-white/60 bg-[#2c323a] rounded-md transition-transform duration-300 ${
              ...
              <div
                className={`transition-all duration-500 overflow-hidden bg-[#111418] ${
                  openIndex === index
                    ? "max-h-40 opacity-100"
                    : "max-h-0 opacity-0"
                }`}
              >
                <div className="px-4 md:px-6 py-4 text-white/70 text-sm leading-relaxed">
                  {faq.answer}
                </div>
              </div>
            </div>
